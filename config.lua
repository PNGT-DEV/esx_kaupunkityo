...
Config.nameJobLabel               = "HSY"
Config.platePrefix                = "HSY"
Config.Locale                     = 'fi'

Config.Vehicles = {
	Truck = {
		Spawner = 1,
		Label = 'HSY Työajoneuvo',
		Hash = "boxville",
		Livery = 0,
		Trailer = "none",
	}	
...
Config.Zones = {
  ...
  Cloakroom = {
    Pos     = {x = -1160.7, y = -217.16, z = 36.96},
    Size    = {x = 1.5, y = 1.5, z = 0.3},
    Color   = {r = 0, g = 0, b = 255},
    Type    = 1,
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = 'Helsingin Seudun Ympäristöpalvelut',
	hint = 'Paina ~INPUT_CONTEXT~ avataksesi vaatekaapin',
  },

  VehicleSpawner = {
	Pos   = {x = -1136.82, y = -200.16, z = 36.96},
	Size  = {x = 1.5, y = 1.5, z = 0.3},
	Color = {r = 0, g = 0, b = 255},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Ajoneuvo",
	hint = 'Paina ~INPUT_CONTEXT~ ottaaksesi ajoneuvon',
  },

  VehicleSpawnPoint = {
	Pos   = {x = -1139.56, y = -211.7, z = 36.92},
  ...
  VehicleDeleter = {
	Pos   = {x = -1151.8, y = -206.35, z = 36.96},
	Size  = {x = 3.0, y = 3.0, z = 0.3},
	Color = {r = 255, g = 0, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Palauta Ajoneuvo",
	hint = 'Paina ~INPUT_CONTEXT~ palauttaaksesi työajoneuvon',
  },

  Vente = {
	Pos   = {x = -1159.22, y = -220.1, z = 40.5},
	Size  = {x = 2.5, y = 2.5, z = 0.3},
	Color = {r = 0, g = 255, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Työlistojen rahastaminen",
	...
	ItemRequires_name = "Työlista",
	ItemDrop = 100,
	ItemPrice  = 800,
	hint = 'Paina ~INPUT_CONTEXT~ rahastaaksesi työlistat',
  },
